export default function Footer() {
  return (
    <footer className="border-t border-zinc-200 bg-brand-dark">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
          <div>
            <div className="flex items-center gap-3 mb-3">
              <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center">
                <span className="text-[8px] font-bold text-brand-dark leading-tight text-center tracking-wider">
                  GYM<br />LOVE!
                </span>
              </div>
        ...
        <div className="mt-10 pt-6 border-t border-white/10 text-center text-xs text-zinc-500">
          Gym Love &mdash; Moda Fitness Boa Vista
        </div>
      </div>
    </footer>
  );
